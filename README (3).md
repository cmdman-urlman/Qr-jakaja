...
## Kameran valinta ja toistonäkymä

- **Vastaanotto:** kun kamera on käynnistynyt, sovellus listaa kaikki laitteen kamerat pudotusvalikkoon (esim. etu- ja takakamera, ulkoiset webkamerat). Valinnan vaihtaminen käynnistää valitun kameran uudelleen ilman että sivua tarvitsee ladata uudelleen.
- **Lähetys:** valmiin videon esikatselu ei käytä selaimen natiiveja videokontrolleja (ei siis kelauspalkkia), koska QR-video on tarkoitettu näytettäväksi sellaisenaan alusta loppuun eikä kelattavaksi. Toistoa/taukoa ohjataan omalla **Pysäytä/Jatka**-napilla, ja **Koko näyttö** suurentaa videon.
